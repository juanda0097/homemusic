...
<body> 
    <section class="content">
        ...
        <h2 style="text-align:center; color:blue;">Interprete</h2>
        ...
        <table width="100%" border="1" style="margin: 0 auto;" id="tabla">
            <thead> 
                <tr>
                    <th>ID</th>
                    <th>Nombre del interprete</th>
                    <th>Nacionalidad</th>
                    
                </tr>
            </thead>
            <tbody>
                @if($interpreterpdf->count())
                @foreach($interpreterpdf as $interpreter)   
                <tr>
                    <td>{{ $interpreter->id}}</td>
                    <td>{{ $interpreter->name}}</td>
                    <td>{{ $interpreter->nationality}}</td>  
